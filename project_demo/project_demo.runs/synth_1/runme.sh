...
HD_PWD='D:/vivado_project/project_demo/project_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_alu_ctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_alu_ctr.tcl
